...
class EndpointsTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_data_answer = {
            "ans_id": 1,
            "answer" : "Fri, 03 Aug 2018 00:00:00 GMT"
        }
    ...
    def test_get_one_question(self):
        res = self.client.post('/stackoverlow/api/v1/questions/1', data=json.dumps(self.test_data_question), content_type='application/json')
        self.assertEqual(res.status_code, 201)
